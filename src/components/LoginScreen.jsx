      ...
      <section className="panel glass-panel screen-fade overflow-hidden px-6 py-10 text-center">
        <div className="mb-8">
          ...
          <p className="mt-4 text-sm leading-6 text-[var(--text-muted)]">
            Habit tracker gnóstico com check-ins diários, progresso em tempo real e arquitetura pronta
            para escalar.
          </p>
        </div>
        ...
        <div className="rounded-[24px] border border-white/8 bg-black/20 p-5 text-left">
          ...
          <p className="mt-2 text-sm text-[var(--text-muted)]">
            No primeiro login, a configuração inicial dos blocos do Albert é criada automaticamente.
          </p>
          <button
